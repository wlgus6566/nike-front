                    ...
                    <div class="noti-box">
                        <ul class="noti-item-list">
                            <li class="noti-item">
                                ...
                                LLC.의 자산입니다. 보안 규정을 준수하시기
                                바랍니다.
                            </li>
                            <li class="noti-item">
                                자료의 조회와 다운로드 이력이 추적 / 관리됩니다.
                                자료의 불법적인 유출은 관련 법에 의거 처벌될 수
                                있습니다.
                            </li>
                        </ul>
                    </div>
    ...
    methods: {
        ...
        handleCheckedCitiesChange(value) {
            ...
            this.isIndeterminate =
                checkedCount > 0 && checkedCount < this.cities;
