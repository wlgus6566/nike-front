<template>
    <div id="wrap">
        ...
        <section id="container">
            <div class="contents">
                <h2 class="page-title">FOUNDATION</h2>
                ...
                <ul class="form-list-thumb">
                    ...
                    <li class="form-row">
                        <div class="form-column">
                            <span class="label-title required">폴더 상태</span>
                        </div>
                        <div class="form-column">
                    ...
                    <li class="form-row">
                        ...
                        <div class="form-column">
                            <el-input type="textarea" :rows="2" v-model="folderNameTextarea" />
                        </div>
                    </li>
                    <li class="form-row">
                        <div class="form-column">
                            <label class="label-title required">폴더 내용</label>
                        </div>
                        <div class="form-column">
                            <el-input type="textarea" :rows="2" v-model="folderDetailTextarea" />
                        </div>
                    </li>
                    <li class="form-row">
                        <div class="form-column">
