...
@font-face {
    ...
    src: local('Noto Sans KR Bold'), local('NotoSansKR-Bold'),
        ...
        /* Super Modern Browsers */ url('NotoSansKR-Regular.woff') format('woff'),
        /* Modern Browsers */ url('NotoSansKR-Regular.ttf') format('truetype'),
        /* Safari, Android, iOS */ url('NotoSansKR-Regular.svg#NotoSansKR')
