...
public class ProductSaveDTO extends BasicDTO {
	 ...
	 * @author [윤태호]
	 */
	@ApiModelProperty(name = "imageFileSize", value = "이미지 파일 사이즈", example = "10000",hidden = true)
	 ...
	 * @author [윤태호]
	 */
	@ApiModelProperty(name = "imageFilePhysicalName", value = "이미지 파일 물리 명", example = "product/test.jpg",hidden = true)
