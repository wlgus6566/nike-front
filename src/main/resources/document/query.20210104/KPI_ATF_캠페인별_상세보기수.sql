...
LEFT JOIN (
    ...
    FROM TB_USER_ACTION_LOG TUAL
    WHERE TUAL.METHOD_SIGNATURE = 'findContents'
    AND REGISTRATION_DT BETWEEN '2020-11-13 11:35:00' AND '2020-12-15 23:59:59'
#     AND REGISTRATION_DT BETWEEN '2020-11-16 00:00:00' AND '2020-12-15 23:59:59'
) T
...
#     AND REGISTRATION_DT BETWEEN '2020-10-26 17:04:53' AND '2020-11-15 23:59:59'
    AND REGISTRATION_DT BETWEEN '2020-11-16 00:00:00' AND '2020-12-15 23:59:59'
) A
GROUP BY CATEGORY;
