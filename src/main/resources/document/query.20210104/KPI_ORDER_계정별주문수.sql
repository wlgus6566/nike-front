...
#                   WHERE TBO.REGISTRATION_DT BETWEEN '2020-09-16 00:00:00' AND '2020-10-15 23:59:59'
#                   WHERE TBO.REGISTRATION_DT BETWEEN '2020-10-16 00:00:00' AND '2020-11-15 23:59:59'
                  WHERE TBO.REGISTRATION_DT BETWEEN '2020-11-16 00:00:00' AND '2020-12-15 23:59:59'
              ) T
         GROUP BY T.AUTH_SEQ
     ) S
