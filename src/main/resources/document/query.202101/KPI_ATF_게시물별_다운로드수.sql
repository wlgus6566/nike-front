...
LEFT JOIN (
  ...
  FROM TB_DOWNLOAD_LOG tdl
           INNER JOIN TB_CONTENTS_FILE tcf
                      ON tdl.FILE_SEQ = tcf.CONTENTS_FILE_SEQ
  WHERE tdl.REGISTRATION_DT BETWEEN '2020-12-16 00:00:00' AND '2021-01-15 23:59:59'
...
-- 특정 기간 TOOLKIT 게시물별 다운로드 수
-- 특정 기간 FOUNDATION 게시물별 다운로드 수
SELECT tc.FOLDER_NAME
     , SUM(CASE
#                WHEN T.REGISTRATION_DT BETWEEN '2020-11-13 11:55:33' AND '2020-11-15 23:59:59' THEN 1
...
FROM TB_CONTENTS tc
    ...
    FROM TB_DOWNLOAD_LOG tdl
             INNER JOIN TB_CONTENTS_FILE tcf
                        ON tdl.FILE_SEQ = tcf.CONTENTS_FILE_SEQ
#     WHERE tdl.REGISTRATION_DT BETWEEN '2020-11-13 11:55:33' AND '2020-11-15 23:59:59'
    WHERE tdl.REGISTRATION_DT BETWEEN '2020-11-16 00:00:00' AND '2020-12-15 23:59:59'
      AND tdl.DOWNLOAD_TYPE = 'CONTENTS'
) T
                   ON T.CONTENTS_SEQ = tc.CONTENTS_SEQ
# WHERE tc.TOP_MENU_CODE = 'TOOLKIT'
...
# AND tc.REGISTRATION_DT BETWEEN '2020-10-24 00:00:00' AND '2020-11-15 23:59:59'
  AND tc.REGISTRATION_DT BETWEEN '2020-11-16 00:00:00' AND '2020-12-15 23:59:59'
GROUP BY tc.CONTENTS_SEQ
;
