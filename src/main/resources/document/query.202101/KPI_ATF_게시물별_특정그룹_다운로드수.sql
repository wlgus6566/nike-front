...
SELECT *
FROM TB_AUTH
WHERE AUTH_SEQ = 28 OR UPPER_AUTH_SEQ = 28 OR UPPER_AUTH_SEQ = 114 OR UPPER_AUTH_SEQ = 115
;
...
SELECT tc.FOLDER_NAME
      , SUM(CASE
                ...
                WHEN T.REGISTRATION_DT BETWEEN '2020-12-16 00:00:00' AND '2021-01-15 23:59:59' THEN 0
                ELSE 0
        END) 'DEC'
        ,
       SUM(CASE
...
#        AND TDL.REGISTRATION_DT BETWEEN '2020-11-16 00:00:00' AND '2020-12-15 23:59:59'
       AND TDL.REGISTRATION_DT BETWEEN '2020-11-16 00:00:00' AND '2021-01-15 23:59:59'
        -- DAEYEON
        ...
        -- WINWIN SPORTS
#             AND (TA.AUTH_SEQ = 22 OR TA.UPPER_AUTH_SEQ = 22 OR TA.UPPER_AUTH_SEQ = 99 OR TA.UPPER_AUTH_SEQ = 100 OR TA.UPPER_AUTH_SEQ = 101 OR TA.UPPER_AUTH_SEQ = 102)
        -- EUNGWANG
#             AND (TA.AUTH_SEQ = 23 OR TA.UPPER_AUTH_SEQ = 23 OR TA.UPPER_AUTH_SEQ = 103 OR TA.UPPER_AUTH_SEQ = 104 OR TA.UPPER_AUTH_SEQ = 105)
        -- SHOE LAND
#             AND (TA.AUTH_SEQ = 24 OR TA.UPPER_AUTH_SEQ = 24 OR TA.UPPER_AUTH_SEQ = 106 OR TA.UPPER_AUTH_SEQ = 107)
        -- HD
#             AND (TA.AUTH_SEQ = 25 OR TA.UPPER_AUTH_SEQ = 25 OR TA.UPPER_AUTH_SEQ = 108 OR TA.UPPER_AUTH_SEQ = 109)
        -- DAESAN SPORTS
#             AND (TA.AUTH_SEQ = 26 OR TA.UPPER_AUTH_SEQ = 26 OR TA.UPPER_AUTH_SEQ = 110 OR TA.UPPER_AUTH_SEQ = 111)
        -- KU & HOOPS
#             AND (TA.AUTH_SEQ = 28 OR TA.UPPER_AUTH_SEQ = 28 OR TA.UPPER_AUTH_SEQ = 114 OR TA.UPPER_AUTH_SEQ = 115)
 ) T
