SELECT *
FROM TB_AUTH
WHERE AUTH_NAME = 'SMH SPORTS KOREA';



SELECT *
FROM TB_AUTH
WHERE AUTH_SEQ = 27 OR UPPER_AUTH_SEQ = 27
...
#             AND (TA.AUTH_SEQ = 26 OR TA.UPPER_AUTH_SEQ = 26 OR TA.UPPER_AUTH_SEQ = 110 OR TA.UPPER_AUTH_SEQ = 111)
       -- SMH SPORTS KOREA
#             AND (TA.AUTH_SEQ = 27 OR TA.UPPER_AUTH_SEQ = 27 OR TA.UPPER_AUTH_SEQ = 112 OR TA.UPPER_AUTH_SEQ = 113)
        -- KU & HOOPS
