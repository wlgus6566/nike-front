...
FROM TB_AUTH TA
     ...
     (
         ...
         WHERE TA.AUTH_DEPTH = 3
           ...
           AND TU.REGISTRATION_DT BETWEEN '2020-08-01 00:00:00' AND '2020-12-15 23:59:59'
         GROUP BY UPPER_AUTH_SEQ
     ) BTA
     ON TA.AUTH_SEQ = BTA.UPPER_AUTH_SEQ
WHERE TA.AUTH_DEPTH = 2
...
#          WHERE TA.AUTH_DEPTH = 2
         AND TU.USER_STATUS_CODE = 'NORMAL'
#          AND TU.REGISTRATION_DT BETWEEN '2020-08-01 00:00:00' AND '2020-10-15 23:59:59'
#          AND TU.REGISTRATION_DT BETWEEN '2020-08-01 00:00:00' AND '2020-11-15 23:59:59'
         AND TU.REGISTRATION_DT BETWEEN '2020-08-01 00:00:00' AND '2020-12-15 23:59:59'
         GROUP BY AUTH_SEQ
     ) BTA
