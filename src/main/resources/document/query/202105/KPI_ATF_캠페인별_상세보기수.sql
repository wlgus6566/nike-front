...
SELECT
    SUM(CASE
            WHEN URL LIKE '%ASSET%' AND URL LIKE '%SP%' THEN 1
            ELSE 0
        END) 'ASSET_SP',
    SUM(CASE
            WHEN URL LIKE '%ASSET%' AND URL LIKE '%SU%' THEN 1
            ELSE 0
        END) 'ASSET_SU',
    SUM(CASE
            WHEN URL LIKE '%ASSET%' AND URL LIKE '%FA%' THEN 1
            ELSE 0
        END) 'ASSET_FA',
    SUM(CASE
            WHEN URL LIKE '%ASSET%' AND URL LIKE '%HO%' THEN 1
            ELSE 0
        END) 'ASSET_HO'
...
SELECT tc.FOLDER_NAME
     , SUM(CASE
               WHEN T.REGISTRATION_DT BETWEEN '2021-03-16 00:00:00' AND '2021-04-15 23:59:59' THEN 1
               ELSE 0
    END) 'MON'
...
#   AND tc.MENU_CODE = 'HO'
# WHERE tc.TOP_MENU_CODE = 'TOOLKIT'
#   AND tc.MENU_CODE = 'VMS'
#   AND tc.MENU_CODE = 'EKIN'
#   AND tc.MENU_CODE = 'SOCIAL'
#   AND tc.MENU_CODE = 'RB'
WHERE tc.TOP_MENU_CODE = 'FOUNDATION'
# AND tc.MENU_CODE = 'VMS'
# AND tc.MENU_CODE = 'EKIN'
# AND tc.MENU_CODE = 'DIGITAL'
AND tc.MENU_CODE = 'RB'
AND tc.REGISTRATION_DT BETWEEN '2021-03-16 00:00:00' AND '2021-04-15 23:59:59'
GROUP BY tc.CONTENTS_SEQ
;
...
FROM TB_CONTENTS tc
    ...
    WHERE tdl.REGISTRATION_DT BETWEEN '2021-03-16 00:00:00' AND '2021-04-15 23:59:59'
