...
--         # FOUNDATION
        ...
        WHERE METHOD_SIGNATURE = 'findContents'
            ...
            AND REGISTRATION_DT BETWEEN '2021-09-16 00:00:00' AND '2021-10-15 23:59:59'
    ) TA
...
#
                   ...
                   END AS MENU_CODE
        FROM TB_CONTENTS
        WHERE REGISTRATION_DT BETWEEN '2021-09-16 00:00:00' AND '2021-10-15 23:59:59'
    ) T
...
WHERE TC.REGISTRATION_DT BETWEEN '2021-09-16 00:00:00' AND '2021-10-15 23:59:59'
