...
LEFT JOIN (
	...
	--      AND TU.USER_STATUS_CODE = 'NORMAL'
	      AND TU.REGISTRATION_DT BETWEEN '2020-08-01 00:00:00' AND '2022-03-15 23:59:59'
...
-- 3DEPTH_그룹_수
 LEFT OUTER JOIN (
    ...
    WHERE AUTH_DEPTH = 3
      AND USE_YN = 'Y'
      AND REGISTRATION_DT BETWEEN '2020-08-01 00:00:00' AND '2022-03-15 23:59:59'
    GROUP BY UPPER_AUTH_SEQ
) TRE_GRU ON TA.AUTH_SEQ = TRE_GRU.UPPER_AUTH_SEQ
WHERE TA.AUTH_DEPTH = 2
   AND TA.USE_YN = 'Y'
  AND TA.REGISTRATION_DT BETWEEN '2020-08-01 00:00:00' AND '2022-03-15 23:59:59'
