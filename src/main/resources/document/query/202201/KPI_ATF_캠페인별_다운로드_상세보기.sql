...
-- --        FOUNDATION
          ...
          WHERE METHOD_SIGNATURE = 'findContents'
            ...
            AND REGISTRATION_DT BETWEEN '2022-01-16 00:00:00' AND '2022-02-15 23:59:59'
      ) TA
...
#
                   ...
                   END AS MENU_CODE
        FROM TB_CONTENTS
        WHERE REGISTRATION_DT BETWEEN '2022-01-16 00:00:00' AND '2022-02-15 23:59:59'
    ) T
...
WHERE TC.REGISTRATION_DT BETWEEN '2022-01-16 00:00:00' AND '2022-02-15 23:59:59'
