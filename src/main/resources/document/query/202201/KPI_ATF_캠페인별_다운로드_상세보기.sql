...
-- --        FOUNDATION
          ...
          WHERE METHOD_SIGNATURE = 'findContents'
            ...
            AND REGISTRATION_DT BETWEEN '2022-03-16 00:00:00' AND '2022-04-15 23:59:59'
      ) TA
...
#
                   ...
                   END AS MENU_CODE
        FROM TB_CONTENTS
        WHERE REGISTRATION_DT BETWEEN '2022-03-16 00:00:00' AND '2022-04-15 23:59:59'
    ) T
...
LEFT JOIN (
    ...
    WHERE TDL.DOWNLOAD_TYPE = 'CONTENTS'
        AND TDL.REGISTRATION_DT BETWEEN '2022-03-16 00:00:00' AND '2022-04-15 23:59:59'
...
WHERE TC.REGISTRATION_DT BETWEEN '2022-03-16 00:00:00' AND '2022-04-15 23:59:59'
