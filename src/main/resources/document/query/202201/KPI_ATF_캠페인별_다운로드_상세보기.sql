...
--        FOUNDATION
        ...
        WHERE METHOD_SIGNATURE = 'findContents'
            ...
            AND REGISTRATION_DT BETWEEN '2021-12-16 00:00:00' AND '2022-01-15 23:59:59'
    ) TA
...
#
                   ...
                   END AS MENU_CODE
        FROM TB_CONTENTS
        WHERE REGISTRATION_DT BETWEEN '2021-12-16 00:00:00' AND '2022-01-15 23:59:59'
    ) T
...
LEFT JOIN (
    ...
    WHERE TDL.DOWNLOAD_TYPE = 'CONTENTS'
        AND TDL.REGISTRATION_DT BETWEEN '2021-12-16 00:00:00' AND '2022-01-15 23:59:59'
...
WHERE TC.REGISTRATION_DT BETWEEN '2021-12-16 00:00:00' AND '2022-01-15 23:59:59'
