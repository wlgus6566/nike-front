...
#         WHEN TA.AUTH_DEPTH = 3 THEN TA.AUTH_SEQ
        ...
        ON TA.UPPER_AUTH_SEQ = UTA.AUTH_SEQ
#         WHERE TR.REGISTRATION_DT BETWEEN '2020-09-24 00:00:00' AND '2020-11-30 23:59:59'
#         WHERE TR.REGISTRATION_DT BETWEEN '2020-09-24 00:00:00' AND '2020-09-30 23:59:59'
#         WHERE TR.REGISTRATION_DT BETWEEN '2020-10-01 00:00:00' AND '2020-10-31 23:59:59'
        WHERE TR.REGISTRATION_DT BETWEEN '2020-11-01 00:00:00' AND '2020-11-30 23:59:59'
        AND TA.AUTH_DEPTH = 3
        # AND TR.USE_YN = 'Y'
        # AND TR.DEVICE = 'PC'
        # AND TUAL.DEVICE = 'MO'
