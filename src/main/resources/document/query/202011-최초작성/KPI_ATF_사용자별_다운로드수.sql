...
WHERE tual.METHOD_SIGNATURE = 'downloadLog'
  AND (tual.REGISTRATION_DT BETWEEN '2020.01.01 11:55:33' AND '2020-11-30 23:59:59')
...
select FILE_SEQ, REGISTRATION_DT from TB_DOWNLOAD_LOG
where REGISTRATION_DT BETWEEN '2020-10-26 17:10:43' AND '2020-11-30 23:59:59'
