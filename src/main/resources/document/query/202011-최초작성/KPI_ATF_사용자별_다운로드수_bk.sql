...
SELECT TU.USER_ID
		...
		, ACTION.COUNT
FROM (
SELECT tual.USER_SEQ, COUNT(tual.USER_SEQ) AS COUNTTB_MENU_ROLE
FROM TB_USER_ACTION_LOG tual
WHERE tual.METHOD_SIGNATURE = 'downloadLog'
AND (tual.REGISTRATION_DT BETWEEN '2020-11-01 00:00:00' AND '2020-12-31 23:59:59')
# AND tual.device = 'PC'
# AND tual.device = 'MO'
...
FROM TB_USER_ACTION_LOG tual
WHERE tual.METHOD_SIGNATURE = 'downloadLog'
  AND (tual.REGISTRATION_DT BETWEEN '2020-11-13 11:10:15' AND '2020-11-13 14:10:15')
